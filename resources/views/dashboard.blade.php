...
@section('content')
    ...
    <h1
        class="text-white mb-10 mt-16 text-5xl font-extrabold tracking-wide flex gap-3 items-center justify-center pb-6 px-8 py-4
    ...
    @if (Auth::user()->role == 'Customer')
        <div class="text-white flex flex-wrap gap-4 items-center justify-center ">
            ...
            <div class="card bg-white/90 w-70 shadow-lg ">
                <figure>
                    <img src="images/users_vt.png" alt="Shoes" />
                </figure>
                <div class="card-body bg-[#3780bd] p-4 rounded-b-lg  ">
                    <h2 class="card-title">My profile</h2>

                    <div class="card-actions justify-end">
                        <a class="btn btn-outline bg-[#008bcc]  hover:border-[#00aeff] hover:bg-[#0051ffb2] hover:text-[#00aeff] mt-4"
            ...
            <div class="card bg-white/90 w-70 shadow-lg ">
                <figure>
                    <img src="images/animals_vs.png" alt="Shoes" />
                </figure>
                <div class="card-body bg-[#3780bd] p-4 rounded-b-lg  ">
            ...
            <div class="card bg-white/90 w-70 shadow-lg ">
                <figure>
                    <img src="images/adoptions_vt.png" alt="Shoes" />
                </figure>
                <div class="card-body bg-[#3780bd] p-4 rounded-b-lg  ">
                    ...
                    <div class="card-actions justify-end">
                        <a class="btn btn-outline bg-[#008bcc]  hover:border-[#00aeff] hover:bg-[#0051ffb2] hover:text-[#00aeff] mt-4"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-4.5 justify-center items-center flex hover:text-[#00aeff]"
                                fill="#fff" viewBox="0 0 256 256">
                                <path
                                    d="M237.66,122.34l-96-96A8,8,0,0,0,128,32V72H104a8,8,0,0,0-8,8v96a8,8,0,0,0,8,8h24v40a8,8,0,0,0,13.66,5.66l96-96A8,8,0,0,0,237.66,122.34ZM144,204.69V176a8,8,0,0,0-8-8H112V88h24a8,8,0,0,0,8-8V51.31L220.69,128ZM48,80v96a8,8,0,0,1-16,0V80a8,8,0,0,1,16,0Zm32,0v96a8,8,0,0,1-16,0V80a8,8,0,0,1,16,0Z">
                                </path>
